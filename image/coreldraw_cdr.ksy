...
instances:
  root_len:
    value: '51_204'
# -rw-r--r-- 1 Petr Pučil 197121     312 říj 14  2014 data1.dat
# -rw-r--r-- 1 Petr Pučil 197121   11108 říj 14  2014 Bitmaps.dat
# -rw-r--r-- 1 Petr Pučil 197121   17349 říj 14  2014 data2.dat
# -rw-r--r-- 1 Petr Pučil 197121     451 říj 14  2014 masterPage.dat
# -rw-r--r-- 1 Petr Pučil 197121 1642871 říj 14  2014 page1.dat
  stream_names:
...
types:
  ...
  mcfg_chunk_data:
    ...
    # mostly reverse-engineered using CorelDraw 9
    seq:
      - id: unknown0
        size: len_unknown0
      - id: old_page_size
